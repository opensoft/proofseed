...
struct Zipper<std::enable_if_t<!IsSpecialization<Left, std::tuple>::value && !IsSpecialization<Right, std::tuple>::value,
                               std::true_type>,
...
template <template <typename...> class Wrapper, typename Left, typename... Right>
struct Zipper<std::enable_if_t<!IsSpecialization<Left, std::tuple>::value, std::true_type>, Wrapper<Left>,
              Wrapper<std::tuple<Right...>>>
{
    using type = Wrapper<std::tuple<Left, Right...>>;
};
